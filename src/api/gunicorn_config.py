...
# For the eventlet and gevent worker classes, this limits the maximum number
# of simultaneous clients that a single process can handle.
worker_connections = 1000
# The number of seconds to wait for the next request on a Keep-Alive HTTP
# connection.
keepalive = 120
# If a worker does not notify the master process in this is spawned to replac
# it.
timeout = 120
